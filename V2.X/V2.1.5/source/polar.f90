  ...
  do rs=1,nseq
    ...
    if ((dpgrp_corr.eqv..false.).and.((do_pka.eqv..true.).or.(do_hsq.eqv..true.))) then 
        ...
        if ((resname.eq."HIP").or.(resname.eq."HIE").or.(resname.eq."HID").or.(resname.eq."HEX").or.&
            ...
            n4=0
            do i=1,at(rs)%npol
            ! Martin : Goes through all of the charge of the residue, and for each dipolar group, 
            ! find out if this atom is the desired one, in chich case save the partial charge 
