...
!
  implicit none
!
  integer i,ica,nn,cc,ncz,ncg,ncd1,ncd2,nnd1,nne2,nnd2,ccm1,shf,iii
  character(3) resname
! some lengths, angles and dihedrals
  RTYPE dh(100),an(100),bo(100),dih1
! see proteus.f for our strategy with regards to eliminating calls of zatom
! with the numbers provided directly as arguments
!
  bo(1) = 1.091d0   ! standard C-H ! Martin change for the sake of consistencu
  ...
  bo(65) = 1.090d0  !Martin added for glycine self consistancy
  an(1) = 0.0d0
  ...
  an(81) = 119.2886d0  ! TRP XCZ3HZ3
  an(82) = 119.35d0 ! TRP XCH2HH2
...
!
  if (resname .eq. 'GLY') then
    if (ua_model.eq.0) then
      ...
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(6,bo(65),an(30),an(31),ica,nn,cc,chiral(i))
    end if
!
! alanine residue  (ALA)
!
...
! phosphoserine residue  (S1P) 
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1274,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1276,bo(55),an(38),chi(1,i),n-1,ica,nn,0)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1277,bo(56),an(90),chi(2,i),n-1,n-2,ica,0)
    chiline(3,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1278,bo(57),an(86),chi(3,i),n-1,n-2,n-3,0) ! Martin : all three Oxygens have the same biotype, this is done assuming some delocalization of the pi-bond
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1278,bo(58),an(88),an(89),n-2,n-1,n-3,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1278,bo(58),an(88),an(89),n-3,n-2,n-4,-1)

    if (ua_model.eq.0) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1275,bo(1),an(2),an(2),n-6,ica,n-5,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1275,bo(1),an(2),an(2),n-7,ica,n-6,-1)
!      chiline(4,i) = n ! Martin : no H on the oxygen
!      nchi(i) = nchi(i) + 1
!      at(i)%nsc = at(i)%nsc + 1
!      at(i)%sc(at(i)%nsc) = n
!      atmres(n) = i
...
!      call z_add(1171,bo(35),an(87),chi(4,i),n-3,n-4,n-5,0)
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1292,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1294,bo(55),an(38),chi(1,i),n-1,ica,nn,0)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1295,bo(56),an(90),chi(2,i),n-1,n-2,ica,0)
    chiline(3,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1297,bo(57),an(86),chi(3,i),n-1,n-2,n-3,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1296,bo(58),an(88),an(89),n-2,n-1,n-3,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1296,bo(58),an(88),an(89),n-3,n-2,n-4,-1)
    if (ua_model.eq.0) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1293,bo(1),an(2),an(2),n-6,ica,n-5,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1293,bo(1),an(2),an(2),n-7,ica,n-6,-1)
      chiline(4,i) = n
      nchi(i) = nchi(i) + 1
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1298,bo(35),an(87),chi(4,i),n-5,n-6,n-7,0)
    else
      chiline(4,i) = n
      nchi(i) = nchi(i) + 1
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1298,bo(35),an(87),chi(4,i),n-3,n-4,n-5,0)
    end if
...
! Martin : changed name 
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1285,bo(5),an(32),an(33),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1287,bo(55),an(39),chi(1,i),n-1,ica,nn,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1288,bo(3),an(8),an(42),n-2,ica,n-1,1)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1290,bo(56),an(90),chi(2,i),n-2,n-3,ica,0)
    chiline(3,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1291,bo(57),an(86),chi(3,i),n-1,n-3,n-4,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1291,bo(58),an(88),an(89),n-2,n-1,n-4,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1291,bo(58),an(88),an(89),n-3,n-2,n-5,-1)
    if (ua_model.eq.0) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1286,bo(1),an(2),an(2),n-7,ica,n-6,-1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1289,bo(1),an(2),dh(2),n-6,n-8,ica,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1289,bo(1),an(2),an(2),n-7,n-9,n-1,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1289,bo(1),an(2),an(2),n-8,n-10,n-2,-1)
!      chiline(4,i) = n
!      nchi(i) = nchi(i) + 1
!      at(i)%nsc = at(i)%nsc + 1
!      at(i)%sc(at(i)%nsc) = n
...
!      call z_add(1186,bo(35),an(87),chi(4,i),n-3,n-4,n-6,0)
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1305,bo(5),an(32),an(33),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1307,bo(55),an(39),chi(1,i),n-1,ica,nn,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1181,bo(3),an(8),an(42),n-2,ica,n-1,1)
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1308,bo(56),an(90),chi(2,i),n-2,n-3,ica,0)
    chiline(3,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1310,bo(57),an(86),chi(3,i),n-1,n-3,n-4,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1309,bo(58),an(88),an(89),n-2,n-1,n-4,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1309,bo(58),an(88),an(89),n-3,n-2,n-5,-1)
    if (ua_model.eq.0) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1306,bo(1),an(2),an(2),n-7,ica,n-6,-1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1182,bo(1),an(2),dh(2),n-6,n-8,ica,0)
      ...
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1311,bo(35),an(87),chi(4,i),n-7,n-8,n-10,0)
    else
      chiline(4,i) = n
      nchi(i) = nchi(i) + 1
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1311,bo(35),an(87),chi(4,i),n-3,n-4,n-6,0)
    end if
...
!     ci always set even for caps
    ...
    call z_add(97,bo(2),an(10),dih1,ica,nn,ccm1,0) ! Cb 
...
!    chiline(1,i) = n
!    nchi(i) = nchi(i) + 1
    call z_add(99,bo(51),an(10),chi(1,i),n-1,ica,nn,0) ! Cg
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
!    chiline(2,i) = n
...
! 
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(124,bo(2),an(8),an(9),ica,nn,cc,chiral(i)) !CB
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncg = n
    call z_add(126,bo(22),an(12),chi(1,i),n-1,ica,nn,0) !CG
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncd1 = n
    call z_add(127,bo(20),an(13),chi(2,i),n-1,n-2,ica,0) !CD
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncd2 = n
!    call z_add(127,bo(20),an(13),an(71),n-2,n-3,n-1,1)
    call z_add(127,bo(20),an(13),dh(2),n-2,n-3,n-1,0) !CD
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(129,bo(18),an(14),dh(1),n-2,n-3,n-1,0) !CE
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd2
    call z_add(129,bo(18),an(14),dh(1),n-2,n-4,n-3,0) !CE
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(131,bo(29),an(15),dh(1),n-2,n-4,n-5,0) !CZ
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!   just a ring closure
    call z_add(-1,bo(52),an(1),dh(1),n-2,n-1,0,0) !ring closure
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(132,bo(33),an(16),dh(2),n-1,n-2,n-4,0) !OH
    if (ua_model.eq.0) then
      shf = 0
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
...
!    call z_add(127,bo(20),an(13),an(71),n-2,n-3,n-1,1)
    ...
    call z_add(1312,bo(18),an(14),dh(1),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd2
    call z_add(1312,bo(18),an(14),dh(1),n-2,n-4,n-3,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1314,bo(29),an(15),dh(1),n-2,n-4,n-5,0)
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!   just a ring closure
    ...
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1315,bo(33),an(16),dh(2),n-1,n-2,n-4,0)
    if (ua_model.eq.0) then
      shf = 0
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
    ...
    if (ua_model.lt.2) then
      ...
      atmres(n) = i
      eqatm(n) = ncd1
      call z_add(1313,bo(23),an(3),dh(2),n-8+shf,n-10+shf,n-11+shf,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(1313,bo(23),an(3),dh(2),n-8+shf,n-10+shf,n-12+shf,0)
    else
      shf = shf + 4
    end if
    chiline(3,i) = n
    ...
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1316,bo(34),an(17),chi(3,i),n-7+shf,n-8+shf,n-9+shf,0)
...
! Martin : changed name 
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1257,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncg = n
    call z_add(1259,bo(22),an(12),chi(1,i),n-1,ica,nn,0)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncd1 = n
    call z_add(1260,bo(20),an(13),chi(2,i),n-1,n-2,ica,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncd2 = n
    call z_add(1260,bo(20),an(13),dh(2),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1262,bo(18),an(14),dh(1),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd2
    call z_add(1262,bo(18),an(14),dh(1),n-2,n-4,n-3,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1264,bo(29),an(15),dh(1),n-2,n-4,n-5,0)
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!   just a ring closure
    ...
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1265,bo(59),an(16),dh(2),n-1,n-2,n-4,0)
    chiline(3,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1266,bo(56),an(91),chi(3,i),n-1,n-2,n-3,0)
    chiline(4,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1267,bo(57),an(86),chi(4,i),n-1,n-2,n-3,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1267,bo(58),an(88),an(89),n-2,n-1,n-3,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1267,bo(58),an(88),an(89),n-3,n-2,n-4,-1)
    if (ua_model.eq.0) then
      shf = 0
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1258,bo(1),an(2),an(2),n-12,ica,n-11,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1258,bo(1),an(2),an(2),n-13,ica,n-12,-1)
    else
      shf = 2
    end if
    if (ua_model.lt.2) then
      ...
      atmres(n) = i
      eqatm(n) = ncd1
      call z_add(1261,bo(23),an(3),dh(2),n-12+shf,n-10+shf,n-8+shf,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(1261,bo(23),an(3),dh(2),n-12+shf,n-10+shf,n-9+shf,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd1
      call z_add(1263,bo(23),an(3),dh(2),n-12+shf,n-14+shf,n-15+shf,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(1263,bo(23),an(3),dh(2),n-12+shf,n-14+shf,n-16+shf,0)
    else
      shf = shf + 4
    end if
!    chiline(5,i) = n
...
!    call z_add(1158,bo(35),an(78),chi(5,i),n-9+shf,n-10+shf,n-11+shf,0)
   ...
   !Martin : yet to be implemented 
    ...
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1299,bo(29),an(15),dh(1),n-2,n-4,n-5,0)
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!   just a ring closure
    ...
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(1300,bo(59),an(16),dh(2),n-1,n-2,n-4,0)
    chiline(3,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1301,bo(56),an(91),chi(3,i),n-1,n-2,n-3,0)
    chiline(4,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1303,bo(57),an(86),chi(4,i),n-1,n-2,n-3,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1302,bo(58),an(88),an(89),n-2,n-1,n-3,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1302,bo(58),an(88),an(89),n-3,n-2,n-4,-1)
    if (ua_model.eq.0) then
      shf = 0
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1304,bo(35),an(78),chi(5,i),n-9+shf,n-10+shf,n-11+shf,0)
!
...
!   just a ring closure
    ...
    if (ua_model.lt.2) then
      ...
      atmres(n) = i
      eqatm(n) = ncd1
      call z_add(144,bo(23),an(28),an(28),n-10+shf,n-11+shf,n-8+shf,1)
    else
      shf = shf + 1
    end if
    at(i)%nsc = at(i)%nsc + 1
    ...
    atmres(n) = i
    eqatm(n) = ncd1
    call z_add(147,bo(24),an(29),an(29),n-9+shf,n-11+shf,n-8+shf,1)
    if (ua_model.lt.2) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(150,bo(23),an(6),an(6),n-8+shf,n-11+shf,n-6+shf,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(152,bo(23),an(80),an(80),n-8+shf,n-10+shf,n-6+shf,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(154,bo(23),an(81),an(81),n-8+shf,n-10+shf,n-7+shf,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(156,bo(23),an(82),an(82),n-8+shf,n-10+shf,n-9+shf,1)
    end if
!
...
!   just a ring closure
  ...
  else if ((resname .eq. 'HEX').or.(resname .eq. 'HIX')) then ! Martin : titrable residues with proton dispaearing from the E carbon
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1229,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1231,bo(25),an(11),chi(1,i),n-1,ica,nn,0)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    nnd1 = n
    call z_add(1232,bo(29),an(43),chi(2,i),n-1,n-2,ica,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncd2 = n
!    call z_add(168,bo(30),an(44),an(45),n-2,n-3,n-1,1)
    call z_add(1234,bo(30),an(44),dh(2),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = nnd1
    call z_add(1236,bo(31),an(42),dh(1),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd2
    call z_add(1238,bo(27),an(47),dh(1),n-2,n-4,n-3,0)
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!   just a ring closure
    ...
    if (ua_model.eq.0) then
      ...
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1230,bo(1),an(2),an(2),n-6,ica,n-5,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1230,bo(1),an(2),an(2),n-7,ica,n-6,-1)
    else
      shf = 2
    end if
    at(i)%nsc = at(i)%nsc + 1
    ...
    atmres(n) = i
    eqatm(n) = nnd1
    call z_add(1233,bo(10),an(48),dh(1),n-6+shf,n-7+shf,n-8+shf,0)
    if (ua_model.lt.2) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(1235,bo(23),an(49),dh(2),n-6+shf,n-8+shf,n-7+shf,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = nnd1
      call z_add(1237,bo(23),an(50),dh(2),n-6+shf,n-8+shf,n-9+shf,0)
    else
      shf = shf + 2
    end if
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1239,bo(10),an(51),dh(2),n-6+shf,n-8+shf,n-10+shf,0)
    
  else if (resname .eq. 'HDX') then ! Martin : titrable residues with proton dispaearing from the E carbon
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1240,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1242,bo(25),an(11),chi(1,i),n-1,ica,nn,0)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    nnd1 = n
    call z_add(1243,bo(29),an(43),chi(2,i),n-1,n-2,ica,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ncd2 = n
!    call z_add(168,bo(30),an(44),an(45),n-2,n-3,n-1,1)
    call z_add(1245,bo(30),an(44),dh(2),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = nnd1
    call z_add(1247,bo(31),an(42),dh(1),n-2,n-3,n-1,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    eqatm(n) = ncd2
    call z_add(1249,bo(27),an(47),dh(1),n-2,n-4,n-3,0)
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!   just a ring closure
    ...
    if (ua_model.eq.0) then
      ...
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1241,bo(1),an(2),an(2),n-6,ica,n-5,1)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1241,bo(1),an(2),an(2),n-7,ica,n-6,-1)
    else
      shf = 2
    end if
    at(i)%nsc = at(i)%nsc + 1
    ...
    atmres(n) = i
    eqatm(n) = nnd1
    call z_add(1244,bo(10),an(48),dh(1),n-6+shf,n-7+shf,n-8+shf,0)
    if (ua_model.lt.2) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = ncd2
      call z_add(1246,bo(23),an(49),dh(2),n-6+shf,n-8+shf,n-7+shf,0)
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      eqatm(n) = nnd1
      call z_add(1248,bo(23),an(50),dh(2),n-6+shf,n-8+shf,n-9+shf,0)
    else
      shf = shf + 2
    end if
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1250,bo(10),an(51),dh(2),n-6+shf,n-8+shf,n-10+shf,0)
    
!  else if (resname .eq. 'HIX') then ! Martin : titrable residues with proton dispaearing from the E carbon
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1240,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
...
! protonated (neutral) aspartic acid residue
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1224,bo(2),an(8),an(9),ica,nn,cc,chiral(i))
    chiline(1,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1225,bo(50),an(67),chi(1,i),n-1,ica,nn,0)
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1226,bo(60),an(28),chi(2,i),n-1,n-2,ica,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    nnd2 = n
    call z_add(1227,bo(61),an(93),dh(2),n-2,n-3,n-1,0)
    if (ua_model.eq.0) then
      shf = 0
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1228,bo(62),an(8),chi(3,i),n-3+shf,n-5+shf,n-6+shf,0)
...
!
    ...
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    call z_add(1086,bo(61),an(93),dh(2),n-2,n-3,n-1,0) ! OE2
    if (ua_model.eq.0) then
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1081,bo(1),an(2),an(2),n-5,ica,n-4,1) ! HB1
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1081,bo(1),an(2),an(2),n-6,ica,n-5,-1) ! HB2
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1083,bo(1),an(2),an(2),n-6,n-7,n-5,1) ! HG
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i
      call z_add(1083,bo(1),an(2),an(2),n-7,n-8,n-6,-1) ! HG
      shf = 0
    else
      shf = 4
    end if
...
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1080,bo(2),an(8),an(9),ica,nn,cc,chiral(i)) ! CB
!    chiline(1,i) = n
!    nchi(i) = nchi(i) + 1
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1212,bo(4),an(64),chi(1,i),n-1,ica,nn,0)! CG
!    chiline(2,i) = n
!    nchi(i) = nchi(i) + 1
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1213,bo(46),an(68),chi(2,i),n-1,n-2,ica,0)! CD
!    chiline(3,i) = n
!    nchi(i) = nchi(i) + 1
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1210,bo(60),an(28),chi(3,i),n-1,n-2,n-3,0) ! OE1
!    at(i)%nsc = at(i)%nsc + 1
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1211,bo(61),an(93),dh(2),n-2,n-3,n-1,0) ! OE2
!    if (ua_model.eq.0) then
!      at(i)%nsc = at(i)%nsc + 1
!      at(i)%sc(at(i)%nsc) = n
!      atmres(n) = i
...
!    at(i)%sc(at(i)%nsc) = n
!    atmres(n) = i
!    call z_add(1209,bo(62),an(86),chi(4,i),n-5+shf,n-7+shf,n-8+shf,0)

 !protonated glutamic acid residue (GLX)  #Tyler ! Extensively modified by martin for the new biotypes

    else if (resname .eq. 'GLX') then ! Martin : Commented out the tyler thing : Not necessary
    if ((do_pka_3 .eqv..false.).and.(do_hsq.eqv..false.)) then
      write(ilog,*) 'You need to have&
& FMCSC_DO_PKA on if you are going to have GLX`s in the sequence!'
      call fexit()
    end if
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    ...
    call z_add(1212,bo(4),an(64),chi(1,i),n-1,ica,nn,0) ! Martin : corrected 
    chiline(2,i) = n
    nchi(i) = nchi(i) + 1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    ...
    call z_add(1210,bo(60),an(28),chi(3,i),n-1,n-2,n-3,0)! Martin : OE1
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
    ...
    if (ua_model.eq.0) then
      ...
      call z_add(1081,bo(1),an(2),an(2),n-5,ica,n-4,1)! HB1 : Does not change
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i

      call z_add(1081,bo(1),an(2),an(2),n-6,ica,n-5,-1)! HB2 : Does not change
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i

      call z_add(1222,bo(1),an(2),an(2),n-6,n-7,n-5,1) ! HG : Does not change
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
      atmres(n) = i

      call z_add(1222,bo(1),an(2),an(2),n-7,n-8,n-6,-1) ! HG2 : Does not change
      shf = 0
    else
      shf = 4
    end if
...
!
    ...
    if ((do_pka_3 .eqv..false.).and.(do_hsq.eqv..false.)) then
      write(ilog,*) 'You need to have&
& FMCSC_DO_PKA on if you are going to have LYX`s in the sequence!'
      call fexit()
    end if
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    ...
    call z_add(1217,bo(4),an(65),chi(3,i),n-1,n-2,n-3,0)
    nchi(i) = nchi(i) + 1
    chiline(4,i) = n
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    ...
    call z_add(1219,bo(9),an(66),chi(4,i),n-1,n-2,n-3,0)
    if (ua_model.eq.0) then
      shf = 0
      at(i)%nsc = at(i)%nsc + 1
      at(i)%sc(at(i)%nsc) = n
    ...
    call z_add(1220,bo(10),an(2),dh(2),n-9+shf,n-10+shf,n-11+shf,0)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
 
    call z_add(1220,bo(10),an(2),an(2),n-10+shf,n-11+shf,n-1,1)
    at(i)%nsc = at(i)%nsc + 1
    at(i)%sc(at(i)%nsc) = n
    atmres(n) = i
 
    call z_add(1221,bo(10),an(2),an(2),n-11+shf,n-12+shf,n-2,-1)
!
