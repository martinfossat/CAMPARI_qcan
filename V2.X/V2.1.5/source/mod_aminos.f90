...
#include "macros.i"
!
! integer codes for possible N-terminal residues: 1-22,24,27-28,33-35,51,64-87,108-115
! integer codes for possible C-terminal residues: 1-22,24,29-30,33-35,51,64-75,108-115
...
!
  ...
  data amino  / 'GLY','ALA','VAL','LEU','ILE','SER','THR','CYS',&
               ...
               &'Y1P','S1P','T1P','GLX','CLX','NAX','LYX','ASX',&
               &'HEX','HDX','S2P','T2P','Y2P','SXP','YXP','TXP',& 
               &'TYX','CH2','CH3','HIX'/
        
  data aminopolty /'P','P','P','P','P','P','P','P',&
                  &'P','P','P','P','P','P','P','P',&
                  &'P','P','P','P','P','P','P','P',&
                  &'P','X','X','X','X','X','P','P',&
                  &'P','P','P','X','X','X','X','X',&
...
!
  ...
  data rescontlen &
             &/  3.64, 3.64, 3.64, 3.64, 3.64, 3.64, 3.64, 3.64,&
                ...
                &3.64, 3.64, 3.64, 3.64, 0.00, 0.00, 3.64, 3.64,&
                &3.64, 3.64, 3.64, 3.64, 3.64, 3.64, 3.64, 3.64,&
                &3.64, 0.00, 0.00,3.64/
  save rescontlen
end module aminos
