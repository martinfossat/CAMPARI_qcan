...
!
  type t_emgrid
    ...
    RTYPE, ALLOCATABLE:: mass(:,:,:),avgmass(:,:,:),vol(:,:,:),dens(:,:,:),deltadens(:,:,:)
...
!
  ...
  RTYPE embgdensity,emthreshdensity,emtotalmass,emavgdensity,emflatval,emthreshdensity2,fdlts(3),emtruncate,emoptbg,emiw
  logical curmassm
  integer, ALLOCATABLE:: emgfls(:,:)
  RTYPE, ALLOCATABLE:: embspld(:,:,:),embspl(:,:,:),embsplbu(:,:),emcustom(:,:)
!
end module ems
