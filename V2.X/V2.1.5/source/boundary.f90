...
!----------------------------------------------------------------------
!
! a routine to correct an out-of-box molecule to its proper image (based on comm)
!
...
!----------------------------------------------------------------------
!
! a routine to correct an out-of-box molecule to its proper image (based on com)
!
...
!
subroutine internal_bound(imol)
!
  use iounit
  use molecule
  use system
