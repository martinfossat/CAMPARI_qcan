...
!--------------------------------------------------------------------------!
!
#include "macros.i"!Macro defines the RTYPE type
!
module fos
!
!
...
!
  type t_savreq! I guess that set the type for Solvent Accessible Volume
...
!
  ...
  RTYPE, ALLOCATABLE:: freesolv_limits(:,:,:)
...
! polypeptide sidechains
  ...
  RTYPE FOS_GLH(3),FOS_ASH(3),FOS_TYO(3),FOS_LYD(3),FOS_CYX(3),FOS_Y1P(3)
  RTYPE FOS_T1P(3),FOS_S1P(3),FOS_GLX(3),FOS_LYX(3),FOS_Y2P(3),FOS_T2P(3)
  RTYPE FOS_S2P(3),FOS_CH2(3),FOS_CH3(3)
